...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUMPAD] = LAYOUT_5x7_2(
        ...
        _______,    KC_INS,    KC_P1,      KC_P2,   KC_P3,   KC_PEQL,                                               KC_PGDN, XXXXXXX,   XXXXXXX, XXXXXXX,    XXXXXXX,    _______,
    ...
    [_FN] = LAYOUT_5x7_2(
        ...
        QK_BOOT,    _______,  _______,    _______,                                                                                         DM_REC1, DM_PLY1,    DM_REC2,    DM_PLY2,
                                                     _______, _______,                                                 _______, _______,
                                                                           _______, _______,       _______, _______,
                                                                           _______, _______,       _______, _______
    )
