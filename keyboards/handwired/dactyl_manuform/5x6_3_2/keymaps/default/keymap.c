...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_5x6_3_2(
        ...
        CW_TOGG,    L2,      OSMWin,    L1,                                                                                  KC_UP,      KC_DOWN,  KC_LEFT,  KC_RGHT,
                                                KC_SPC, KC_DEL,                                             KC_BSPC, KC_ENT,
                                                                OSMLA,  OSMLC,         OSMRC,   OSMRA,
                                                                SH_TG,  KC_ENT,        KC_PGUP, KC_PGDN
    ),
    ...
    [_NUMPAD] = LAYOUT_5x6_3_2(
        ...
        _______,    XXXXXXX,  KC_P1,      KC_P2,   KC_P3,   KC_PEQL,                                               KC_PGDN, XXXXXXX,   XXXXXXX, XXXXXXX,    XXXXXXX,    _______,
        _______,    _______,  _______,    _______,                                                                                     _______, _______,    _______,    _______,
                                                   _______, _______,                                               _______, _______,
                                                                       _______, _______,       _______, _______,
                                                                       _______, _______,       KC_PSCR, KC_INS
    ),
